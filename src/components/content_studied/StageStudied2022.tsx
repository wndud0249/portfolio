...
interface StageStudied2022Props {
...
const StageStudied2022 = ({
  focusedBookTitle,
  onMouseOverBookTitle,
  onMouseLeaveBookTitle,
  onContent4,
  focusedStage,
}: StageStudied2022Props) => {
  return (
    <>
        ...
        <div className="content_wrapper">
          ...
          <div className="time_line_list">
            ...
            <div className="time_line_item_wrapper">
              <div
                className={
                  focusedStage === 'stage_4-1' ? 'time_line_item on doIt' : 'time_line_item doIt'
                }
              ></div>
            </div>
          </div>
          ...
          <div
            className={focusedBookTitle === 'it' ? 'time_line_list focused' : 'time_line_list'}
          ...
          <div
            className={focusedBookTitle === 'yalco' ? 'time_line_list focused' : 'time_line_list'}
            onMouseOver={onMouseOverBookTitle}
            onMouseLeave={onMouseLeaveBookTitle}
          ...
          <div
            className={focusedBookTitle === 'modern' ? 'time_line_list focused' : 'time_line_list'}
            onMouseOver={onMouseOverBookTitle}
            onMouseLeave={onMouseLeaveBookTitle}
          ...
          <div
            className={
              focusedBookTitle === 'dreamBrowser' ? 'time_line_list focused' : 'time_line_list'
            }
            onMouseOver={onMouseOverBookTitle}
            onMouseLeave={onMouseLeaveBookTitle}
...
export default StageStudied2022;
