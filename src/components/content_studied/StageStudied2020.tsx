...
interface StageStudied2020Props {
...
const StageStudied2020 = ({
  focusedBookTitle,
  onMouseOverBookTitle,
  onMouseLeaveBookTitle,
  onContent4,
  focusedStage,
}: StageStudied2020Props) => {
  return (
    <>
      <div className="stage_4-1">
        <div className="content_wrapper">
          ...
          <div
            className={focusedBookTitle === 'lifeJs' ? 'time_line_list focused' : 'time_line_list'}
            onMouseOver={onMouseOverBookTitle}
            onMouseLeave={onMouseLeaveBookTitle}
          ...
          <div
            className={focusedBookTitle === 'lifeGit' ? 'time_line_list focused' : 'time_line_list'}
            onMouseOver={onMouseOverBookTitle}
            onMouseLeave={onMouseLeaveBookTitle}
...
export default StageStudied2020;
